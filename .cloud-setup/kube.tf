...
module "kube-hetzner" {
  ...
  traefik_additional_trusted_ips = ["45.232.88.13"]
  ...
  firewall_kube_api_source = ["45.232.88.13"]
...
defaultSettings:
  ...
  # WORKAROUND: https://github.com/mysticaltech/terraform-hcloud-kube-hetzner/issues/1951
...
terraform {
  ...
  backend "s3" {
    ...
    # Set the region of your bucket (e.g., fsn1, nbg1, hel1)
    region = "fsn1"
    ...
    # Required for Hetzner Object Storage
