  ...
  - [Customization](#customization)
    ...
    - [Extensions](#extensions)
      - [Apis Nav Item](#apis-nav-item)
        ...
        - [Config](#config)
        - [Override](#override)
      - [Apis Explore Page](#apis-explore-page)
        - [Disable/Enable](#disableenable)
        - [Override](#override-1)
      - [Apis Entities Cards](#apis-entities-cards)
    ...
    - [Apis Entity Contents](#apis-entity-contents)
      ...
      - [Apis Config Api](#apis-config-api)
        ...
        - [Adding `requestInterceptor` to Swagger UI](#adding-requestinterceptor-to-swagger-ui)
        - [Provide Specific Supported Methods to Swagger UI](#provide-specific-supported-methods-to-swagger-ui)
    ...
    - [Integrations](#integrations)
      - [Implementing OAuth 2 Authorization Code flow with Swagger UI](#implementing-oauth-2-authorization-code-flow-with-swagger-ui)
        - [Adding `oauth2-redirect.html` to support OAuth2 `redirect_uri` route](#adding-oauth2-redirecthtml-to-support-oauth2-redirect_uri-route)
        - [Configuring your OAuth2 Client](#configuring-your-oauth2-client)
        - [Configuring OAuth2 in your OpenAPI 3.0 schema](#configuring-oauth2-in-your-openapi-30-schema)
